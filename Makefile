...
call:
	...
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.Get '{"name":"test1"}'
	echo # 操作员加入
	...
	echo # 通过任务
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"8a8c26af4df5ac2c617688fd84218899", "operator":"001"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"8a8c26af4df5ac2c617688fd84218899", "operator":"002"}'
	echo # 查询记录
	MICRO_REGISTRY=consul micro call omo.msa.approval Action.Query '{"task":"8a8c26af4df5ac2c617688fd84218899"}'
	echo # 通过任务
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"8a8c26af4df5ac2c617688fd84218899", "operator":"003"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"8a8c26af4df5ac2c617688fd84218899", "operator":"004"}'
	echo # 查询记录
	MICRO_REGISTRY=consul micro call omo.msa.approval Action.Query '{"task":"8a8c26af4df5ac2c617688fd84218899"}'
	echo # 列举任务
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	...
	echo #  代码覆盖测试 - 任一工作流
	echo # -------------------------------------------------------------------------
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.Make '{"name":"test2", "mode": 2}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.List
	MICRO_REGISTRY=consul micro call omo.msa.approval Operator.BatchJoin '{"operator":["a", "b", "c"], "workflow":"ad0234829205b9033196ba818f7a872b"}'
	...
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"a"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"b"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"c"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"c"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"b"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"b6a3001a1408e614a2a6fe7bb7e208a5", "operator":"a"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	echo # -------------------------------------------------------------------------
	echo #  代码覆盖测试 - 半票工作流
	echo # -------------------------------------------------------------------------
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.Make '{"name":"test3", "mode": 3}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.List
	MICRO_REGISTRY=consul micro call omo.msa.approval Operator.BatchJoin '{"operator":["a", "b", "c"], "workflow":"8ad8757baa8564dc136c1e07507f4a98"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Submit '{"subject":"subject-3", "body": "boby-3", "workflow":"8ad8757baa8564dc136c1e07507f4a98"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"a"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"b"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Accept '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"c"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"c"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"b"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.Reject '{"uuid":"245be4cc1f88180bb9bb7e86f4f9330b", "operator":"a"}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Task.List 
	echo # -------------------------------------------------------------------------
	echo #  缺省参数测试
	echo # -------------------------------------------------------------------------
	...
	# @过半工作流
	MICRO_REGISTRY=consul micro call omo.msa.approval Workflow.Make '{"name":"test2", "mode": 2}'
	MICRO_REGISTRY=consul micro call omo.msa.approval Operator.BatchJoin '{"operator":["A", "B"], "workflow":"ad0234829205b9033196ba818f7a872b"}'
